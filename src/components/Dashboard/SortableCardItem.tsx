...
/**
 * Sortable wrapper for a VersionCard.
 ...
 * - Exposes dragHandleProps ({ attributes, listeners }) for the card to render
 *   the drag handle wherever it wants (e.g. inside the header bar).
 */
export function SortableCardItem({
  ...
  return (
    <div ref={setNodeRef} style={style} className="relative group">
      ...
      {/* Render children with dragHandleProps injected via cloneElement or context */}
