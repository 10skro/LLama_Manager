...
export function parseKey(key: string): { buildNumber: string; backend: string; architecture: string } {
...
export function getRowKey(build: { download_url: string; build_number: string; backend: string; architecture: string }): string {
